...
class ICTests : BaseIncrementalCompilationTest() {
  ...
  /**
   * Tests that removing a non-assisted parameter from an @AssistedInject class is correctly
   * detected during incremental compilation when the factory is contributed into a set via a
   *
   * @BindingContainer, matching the real-world crash pattern.
   *
